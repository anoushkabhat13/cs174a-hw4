...
export class Assignment4 extends Scene {
    ...
    display(context, program_state) {
        ...
        this.shapes.box_1.draw(context, program_state, this.cube1_transform, this.materials.texture);
        this.shapes.box_2.draw(context, program_state, this.cube2_transform, this.materials.texture2);
